...
import com.tutorial.database.Connector;
import com.tutorial.screen.Registration;
...
//BUTTON PANEL
        ...
        btnTambahPanel.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                try {
                    ...
                    connector.statement = connector.con.createStatement();
        ...
        btnLihat.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent arg0) {
                Registration lihat = new Registration();
            }
        });
    }
